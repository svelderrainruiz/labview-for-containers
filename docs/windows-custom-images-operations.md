...
For org governance and upstream sync policy, see
[Org Integration Hub](./org-integration-hub.md).
...
- [Certification Incident Response](#certification-incident-response)
- [Org Integration Hub Policy](#org-integration-hub-policy)
...
## Certification Incident Response

When certification regresses, follow:

- [Image Contract Incident Response](./image-contract-incident-response.md)

Do not skip classification and evidence capture before applying fixes.

## Org Integration Hub Policy

Repository integration and upstream-sync policy for this program is documented
in:

- [Org Integration Hub](./org-integration-hub.md)

Acceptance decisions and certification evidence for this program should be
recorded in org issues/PRs instead of split across personal forks.
...
1. `examples/integration-into-cicd/runlabview.ps1` should be invoked with
   explicit year/path assumptions in automation.
